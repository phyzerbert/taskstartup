...
// insert notification
	...
	?>
	<div class="mainform">
	<form action="comment_frame.php?post_id=<?php echo $post_id; ?>" id="comment_form" name="postComment<?php echo $post_id; ?>" method="POST" enctype="multipart/form-data">
      ...
      >
		...
		<textarea id="post_text" name="post_body"></textarea>
			...
			<input type="hidden" name="parentcomment" id="parentc"  value="0">
...
if(source.match(regexToken))
{
    ...
    //return urlArray;
       ...
       $("#post_buttonsub"+posti).attr('type','submit');
       //$("#comment_form"+posti).submit();
